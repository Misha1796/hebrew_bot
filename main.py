...
# Это лечит ошибку 404, заставляя библиотеку использовать стабильную ветку v1
...
async def handle_ai_voice(message: types.Message):
    ...
    try:
        # Явно указываем mime_type, чтобы избежать ошибки из логов
...
# --- СЮДА МОЖНО ДОБАВИТЬ ТВОИ ФУНКЦИИ ТРЕНАЖЕРА (send_question и т.д.) ---
